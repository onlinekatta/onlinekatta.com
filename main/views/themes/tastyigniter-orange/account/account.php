				...
				<div class="row">
					...
					<div class="col-md-12" style="font-size:12px;">
						...
						<ul id="nav-tabs" class="nav nav-tabs nav-tabs-line">
							...
							<li><a href="#mess_subscription" data-toggle="tab"><?php echo lang('text_mess'); ?></a></li>
					...
					<div class="col-md-12">
						...
						<div class="tab-content tab-content-line wrap-top">
							...
							<div id="mess_subscription" class="tab-pane">

								<div class="row">
									<div class="btn-group btn-group-md col-md-12">
                                        <a class="pull-right" href="<?php echo $print_invoice; ?>" data-original-title="" title=""><span class="fa fa-print"></span> Invoice</a>
									</div>
								</div>
												...
												<td class="payment_row" id="payment_row_<?php echo $subscription_history['customer_subscription_id']; ?>">
													<table style="font-size:10px;">
														...
														?>
															<tr>
																<td>
																	<?php echo $subscriptions_payment_history->payment; ?> (<?php echo $subscriptions_payment_history->created_at; ?>) <a href="<?php echo $subscription_history['print']; ?>/<?php echo $subscriptions_payment_history->csh_id; ?>"><span class="fa fa-print"></span></a>
																</td>
															</tr>
														<?php } ?>
													</table>
