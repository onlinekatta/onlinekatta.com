...
$lang['alert_caution_edit'] 	        = '<b>CAUTION!</b> You may lose your modifications to this email template when you update Smart-Resto by OnlineKatta.<br> Clone the default template from the add new mail template page to make changes.';
