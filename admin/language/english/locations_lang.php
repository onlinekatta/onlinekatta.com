...
$lang['text_tab_configuration'] 		= 'Configuration';
...
$lang['text_configuration_buffet'] 		= 'Buffet Configuration Manager';
$lang['text_configuration_subscription'] 		= 'Subscription Configuration Manager';
$lang['text_configuration_restaurant_cafe'] 		= 'Restaurant/Cafe Configuration Manager';
$lang['text_add_new_area'] 		        = 'Add new area';
$lang['text_subscription_extra_days'] 		= 'Number of extra days for redemption';
$lang['text_subscription_value'] 		= 'Subscription Value';
$lang['text_subscription_name'] 		= 'Subscription Name';
$lang['text_cyce'] 		= 'Select subscription cycle';
$lang['text_number_meal'] 		= 'Number of Meal';
$lang['text_redemption_threshold'] 		= 'Redemption Threshold';
$lang['text_repetion_frequency'] 		= 'Repetition Frequency';
...
$lang['label_manager_name'] 		            = 'Location Manager name';
...
$lang['label_out_range'] 			    = 'Accept Out Range Order';
$lang['label_future_order_days'] 		= 'Future Order Days In Advance';
$lang['label_payments'] 		        = 'Payments';
$lang['label_tables'] 		            = 'Tables';
$lang['label_location_configuration']   = 'Restaurant Location Configuration';
...
$lang['alert_set_subscription_name']    = 'Subscription Name to be displayed';
$lang['alert_set_value'] 		        = 'Currency Value for the subscription';
$lang['alert_set_meal'] 		        = 'Number of meals per day to be delivered';
$lang['alert_set_cycle'] 		        = 'Number of cycles for the subscription';
$lang['alert_set_extra_days'] 		    = 'Number of extra days that can be added.';
$lang['alert_set_subscription_action'] 	= 'Allow subscription action';
$lang['alert_set_subscription_description'] 	= 'Detail of the subscription';
...
$lang['help_out_of_range']        		 = 'Accept order from front end or from admin even if it is set out of range defined. ';
...
$lang['help_restaurant_configuration']  = 'Set restaurant location configuration for dining hall, and restaurant, cafe, bistro, pub, lounge for your customers';
...
$lang['help_configuration_buffet'] 		= 'Configure and manage options for Buffet / Thali based restaurant system!';
$lang['help_configuration_subscription'] 		= 'Configure and manage options for Subscription based restaurant system!';
$lang['help_buffet_fixed_menu'] 		= 'Does this restaurant location offer Daily / Weekly / Monthly fixed menu schedule?';
$lang['help_buffet_repetition_mode'] 		= 'Does this restaurant location offer Fixed Menu\'s Repetition schedule?';
