			...
			<div class="tab-content">
				...
				<div id="mail" class="tab-pane row wrap-all">
					...
					<div id="smtp-settings">
						...
						<div class="form-group">
							<label for="input-send-smtp-test-email" class="col-sm-3 control-label"><?php echo lang('label_test_smtp_email'); ?></label>
							<div class="col-sm-5">
								<a id="input-send-smtp-test-email" class="btn btn-primary btn-block"><?php echo lang('text_send_test_smtp_email'); ?></a>
							</div>
						</div>
					</div>
					<div class="form-group">
...
$(document).ready(function() {
    ...
    $('#input-send-smtp-test-email').click(function() {
        var obj = $(this);

        $.ajax({
            url: js_site_url('settings/sendSMTP_test_mail'),
            type: 'POST',
