...
$this->template->setStyleTag('css/jquery.auto-complete.css', 'jquery-auto-complete-css');
...
$this->template->setScriptTag('js/jquery.auto-complete.min.js', 'jquery-auto-complete-js');
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <body>
        <div class="overlay">
            <img class="logo-image" alt="<?php echo $overlay_loading; ?>" title="<?php echo $overlay_loading; ?>" src="<?php echo $overlay_loading; ?>"/>
        </div>
                ...
                <div class="navbar-header">
                    <div class="navbar-brand">
                        <div class="navbar-logo col-xs-3">
                            <img class="logo-image" alt="<?php echo $system_name; ?>" title="<?php echo $system_name; ?>" src="<?php echo $smartresto_logo; ?>"/>
                        </div>
