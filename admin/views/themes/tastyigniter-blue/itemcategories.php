				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="id"><a class="sort" href="<?php echo $sort_id; ?>"><?php echo lang('column_id'); ?> <i class="fa fa-sort-<?php echo ($sort_by === 'item_category_id') ? $order_by_active : $order_by; ?>"></i></a></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td class="action"><input type="checkbox" name="delete[]" value="<?php echo $category['item_category_id']; ?>" />&nbsp;&nbsp;&nbsp;
                            ...
                            <td>
                                <?php foreach ($itemcategories as $cat) { ?>
                                    <?php if ($category['parent_id'] === $cat['item_category_id']) { ?>
                                        <?php echo $cat['name']; ?>
                                    <?php } ?>
                                <?php } ?>
                            </td>
							...
							<td class="id"><?php echo $category['item_category_id']; ?></td>
						</tr>
