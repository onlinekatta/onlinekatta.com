            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" id="compose-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="input-subject" class="col-sm-3 control-label">
                                    <input type="checkbox" name="activate_social_media" id="activate_social_media">
                                    <?php echo lang('label_social_media'); ?>
                                </label>
                                <div class="col-sm-9">
                                    <div id="box_social_default"><br /></div>
                                    <div id="box_social_media">
                                        <?php 
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea name="body" id="input-wysiwyg" class="form-control" style="height:300px;width:100%;">
                                    <?php $body = str_replace("<p>","", $body); ?>
                                    <?php $body = str_replace("</p>","", $body); ?>
                                    <?php $body = str_replace("<br>"," ", $body); ?>
                                    <?php echo set_value('body', $body); ?></textarea>
...
$(document).ready(function(){
    $('#activate_social_media').click(function () {
        if ($(this).is(':checked')) {
            $('#box_social_default').fadeOut(function(){
                $('#box_social_media').fadeIn(); 
            });
        }else{
            $('#box_social_media').fadeOut(function(){
                $('#box_social_default').fadeIn(); 
            });
        }
    });
});
