<div id="footer" class="<?php echo ($this->user->islogged()) ? '' : 'wrap-none'; ?>">
	<div class="row navbar-footer">
		<div class="col-sm-12 text-version">
			<p class="col-xs-9 wrap-none"><?php echo "Thanks for creating with <a href='https://www.oninekatta.com/'>Smart-Resto</a>" ?></p>
			<p class="col-xs-3 text-right wrap-none"><?php echo "powered by: <a href='https://www.oninekatta.com/'>OnlineKatta</a>"; ?></p>
		</div>
	</div>
</div>
