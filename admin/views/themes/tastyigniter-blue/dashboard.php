                    ...
                    <div class="panel panel-default panel-statistics">
                        <div class="panel-heading">
                            <div class="form-inline">
                                <div class="row">
                                    <div class="col-md-5 pull-left">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_inventory'); ?></h3>
                                    </div>
                        ...
                        <div id="statistics" style="max-height:600px;overflow-y: scroll;">
                            <ul class="list-group text-sm">
                            <?php foreach($inventories as $inventory): ?>
                                <li class="list-group-item<?=(($inventory['stock_qty']<=($inventory['minimum_qty']+100) AND ($inventory['stock_qty']>=($inventory['minimum_qty']-1)))?' list-group-item-warning':(($inventory['stock_qty']<$inventory['minimum_qty'])?' list-group-item-danger':''))?>" >
                                    <a href="<?php echo site_url('items/edit?id='.$inventory['item_id']); ?>"><?php echo $inventory['item_name']; ?></a>
                                    <span class="" style="font-size:12px;"><?php echo $inventory['stock_qty']." ".$inventory['measuring_unit']; ?></span>
                                </li>
                            <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="panel-footer">
                            <span class="bg-warning" style="border-radius:2px;padding:2px 10px;">&nbsp;&nbsp;</span> <?php echo lang('text_about_treshold'); ?> &nbsp;&nbsp;
                            <span class="bg-danger" style="border-radius:2px;padding:2px 10px;">&nbsp;&nbsp;</span> <?php echo lang('text_under_treshold'); ?>
                        </div>
                    </div>
                </div>
