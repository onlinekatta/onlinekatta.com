				...
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<?php if ($category['item_category_id'] === $parent_id) { ?>
								<option value="<?php echo $category['item_category_id']; ?>" <?php echo set_select('parent', $category['item_category_id'], TRUE); ?> ><?php echo $category['category_name']; ?></option>
							<?php } else { ?>
								<option value="<?php echo $category['item_category_id']; ?>" <?php echo set_select('parent', $category['item_category_id']); ?> ><?php echo $category['category_name']; ?></option>
							<?php } ?>
							<?php } ?>
							</select>
