...
$theme['nav_menu'] = array(
	...
	'inventory' => array(
		'class' => 'inventory',
		'icon' => 'fa-archive',
		'title' => lang('menu_inventory'),
		'permission' => 'Admin.Items|Admin.MenuOptions|Admin.Categories',
		'child' => array(
			'items' => array('class' => 'items', 'href' => site_url('items'), 'title' => lang('menu_items'), 'permission' => 'Admin.Menus'),
			//'menu_options' => array('class' => 'menu_options', 'href' => site_url('menu_options'), 'title' => lang('menu_option'), 'permission' => 'Admin.MenuOptions'),
			'itemCategories' => array('class' => 'itemCategories', 'href' => site_url('itemCategories'), 'title' => lang('menu_category'), 'permission' => 'Admin.Categories'),
		)
	),
	'sales' => array(
		'class' => 'sales',
	...
	'marketing' => array(
		...
		'child' => array(
			...
			'social_campaign' => array('class' => 'social_campain', 'href' => site_url('social_campain'), 'title' => lang('menu_social_campaign'), 'permission' => 'Admin.SocialMedia'),
	...
	'reports' => array(
		'class' => 'reports',
		'icon' => 'fa-bar-chart-o',
		'title' => lang('menu_reports'),
		'permission' => 'Admin.Reports',
		'child' => array(
			'social_media' => array('class' => 'reports', 'href' => site_url('reports'), 'title' => lang('menu_social_media'), 'permission' => 'Admin.Reports'),
			'inventory' => array('class' => 'inventory', 'href' => site_url('inventories'), 'title' => lang('menu_inventory'), 'permission' => 'Admin.Reports'),
			// 'messages' => array('class' => 'messages', 'href' => site_url('messages'), 'title' => lang('menu_messages'), 'permission' => 'Admin.Messages'),
		)
	),
	'restaurant' => array(
...
//			'uri_routes' => array('class' => 'uri_routes', 'href' => site_url('uri_routes'), 'title' => lang('menu_uri_route')),
			...
			'social_media' => array('class' => 'social_media', 'href' => site_url('social_media'), 'title' => lang('menu_social_media'), 'permission' => 'Admin.SocialMedia'),
			'tools' => array(
				'class' => 'tools',
	...
	'attendance' => array(
		'class' => 'attendance',
		'icon' => 'fa-cog',
		'title' => lang('menu_attendance'),
		'href' => site_url('attendance')
		//'permission' => 'Site.Attendance',
	),
	'collapse' => array(
