            ...
            <div class="tab-content">
                <div id="general" class="tab-pane row wrap-all active">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">                            
                            <select name="menu_location" id="location" class="form-control">
                                <option value=""><?php echo lang('text_select_location'); ?></option>
                                <?php foreach ($locations as $location) { ?>
                                    <?php if (!empty($location['location_id'])) { ?>
                                        <?php if ($location['location_id'] == $menu_location) { ?>
                ...
                <div id="menu-details" class="tab-pane row wrap-all">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="stock_qty" id="input-stock" disabled="" class="form-control" value="<?php echo set_value('stock_qty', $stock_qty); ?>" />
...
<script type="text/javascript"><!--
    ...
    $("#input-name").keyup(function(){
        ...
        $.ajax({
            url: '<?php echo site_url("/menus/checkMenu"); ?>',
            data: "menu_name="+menu+"&location_id="+location_id,
            method: 'POST',
            dataType: 'json',
            success: function(data) {
                if(data.name == menu){
                    alert('The Menu you entered already exists at that location!');
                    $("#input-name").val("");
                }
            }
        });
