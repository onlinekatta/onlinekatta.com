            ...
            <div class="tab-content">
                <div id="general" class="tab-pane row wrap-all active">
                    ...
                    <div class="form-group">
                        ...
                        if ($query->num_rows() > 0) {
                            $row = $query->row();
                            $default_location = $row->location_name;
                        }

                        if ($rowcount != 0) {
                            ?>
                            <div class="col-sm-5">
                                <input type="text" readonly name="location_name" id="input-name" class="form-control" value="<?php echo $default_location; ?>" />
                ...
                <div id="configuration" class="tab-pane row wrap-all">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <?php if ($buffet == 1 && $subscription == 1 && $restaurant_cafe == 1) { ?>
...
<!-- <input type="checkbox" name="combination_meal" id="combination_meal"> Combination (Select All) -->
                                <div class="col-md-12" style="margin-left:40px;">
                                    <div class="form-group">
                                        <?php if ($buffet == 1 && $subscription == 1) { ?>
        ...
        <!-- <input type="checkbox" name="dining_hall" id="dining_hall"> Dining Hall / Restaurant -->
                                    ...
                                    <div class="form-group">
                                        <?php if ($biometric == 1) {
                                            ?>
                                            <input type="checkbox" name="biometric" id="biometric" value="<?php echo $biometric; ?>" autocomplete="off" checked />
                                            <div class="btn-group">
                                                <label for="biometric" class="btn btn-default">
                                                    <span class="fa fa-check"></span>
                                                    <span> </span>
                                                </label>
                                                <label for="biometric" class="btn btn-default active">
                                                    Biometric
                                                </label>
                                            </div>
                                        <?php } else { ?>
                                            <input type="checkbox" name="biometric" id="biometric"  autocomplete="off" value="<?php echo $biometric; ?>" />
                                            <div class="btn-group">
                                                <label for="biometric" class="btn btn-default">
                                                    <span class="fa fa-check"></span>
                                                    <span> </span>
                                    ...
                                    <div id="subscription<?php echo $table_row; ?>" class="tab-pane row wrap-all">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <input onkeypress="return isNumberKey(event)" type="text" name="subscription[<?php echo $table_row; ?>][subscription_value]" id="input-subscription-value" class="form-control"  value="<?php echo set_value('subscription[<?php echo $table_row; ?>][subscription_value]', $subscription['subscription_value']); ?>" />
                                        ...
                                        <div class="row" style="margin-bottom:5px;">
                                            <div class="col-sm-8">
                                                ...
                                                <div class="col-sm-12">
                                                    <input onkeypress="return isNumberKey(event)" type="text" name="subscription[<?php echo $table_row; ?>][meals_per_day]" id="input-meals-per-day" class="form-control" value="<?php echo set_value('subscription[<?php echo $table_row; ?>][meals_per_day]', $subscription['meals_per_day']); ?>" />
                                                    <?php echo form_error('reservation_time_interval', '<span class="text-danger">', '</span>'); ?>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function addSubscription() {
        ...
        html += '							<input onkeypress="return isNumberKey(event)" type="text" name="subscription[' + table_row + '][subscription_value]" id="input-subscription-value" class="form-control"  value="<?php echo set_value("subscription[' + table_row + '][subscription_value]"); ?>" />';
        ...
        html += '				</label>';
        html += '				<div class="col-sm-12">';
        html += '					<input onkeypress="return isNumberKey(event)" type="text" name="subscription[' + table_row + '][meals_per_day]" id="input-meals-per-day" class="form-control" value="<?php echo set_value("subscription[' + table_row + '][meals_per_day]"); ?>" />';
