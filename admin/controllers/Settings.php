...
class Settings extends Admin_Controller {
	...
	public function sendSMTP_test_mail() {
		...
		if (empty($json)) {
	        ...
	        $this->email->subject('Test SMTP mail from Smart-Resto');

	        $this->email->message('This is a test email. If you\'ve received this, it means SMTP emails are working in Smart-Resto.'); 
	...
	public function send_test_email() {
		...
		if (empty($json)) {
			...
			$this->email->message('This is a test email. If you\'ve received this, it means emails are working in Smart-Resto.');
